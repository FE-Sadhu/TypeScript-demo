...
// 枚举 enum 类型
enum Color {Red, Green, Blue} // 编译成 js 后的是一个对象, 默认值从 0 开始编号 -> 0 1 2
let c: Color = Color.Green
console.log(Color) // { '0': 'Red', '1': 'Green', '2': 'Blue', Red: 0, Green: 1, Blue: 2 }
console.log(c) // 1

// 把上面例子改成从 1 开始编号
enum Color2 {Red = 1, Green, Blue} // 从 1 开始编号 -> 1, 2, 3
...
let t2: string | null | undefined // 采用联合类型
t2 = 'a'
t2 = null
t2 = undefined
// t2 = 1 // 报错
...
// 使用方法二 -> as 关键字
let otherValue: any = 'This is other value'
